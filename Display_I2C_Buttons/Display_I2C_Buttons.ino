...
int* btn_y[13] = {0, 15, 15, 15, 15, 94, 94, 94, 94, 5, 5, 5, 5};
...
*/
  ...
  drawRamecek(0,79,98,71, RAMECEK, TOPENI);
  drawRamecek(100,79,98,71, RAMECEK, TOPENI);
  drawRamecek(200,79,98,71, RAMECEK, TOPENI);
  drawRamecek(300,79,98,71, RAMECEK, TOPENI);
 ...
 void setPos(int btn){
          ...
          while(btn_xy > 0){
              ...
              if(pos_set > 0){
                ...
                mydisp.setTextPosOffset(btn_xy, 0);   
              }              
              btn_xy = pos_set;              
            }
          ...
          while(btn_xy > 0){
              ...
              pos_set = btn_xy - 127;
              if(pos_set > 0){
                mydisp.setTextPosOffset(0, 127);             
              }else{
                mydisp.setTextPosOffset(0, btn_xy);   
              }              
              btn_xy = pos_set;              
            }
